...
protocol RMSearchViewDelegate: AnyObject {
    func rmSearchView(_ searchView: RMSearchView, didSelectionOption option: RMSearchInputViewViewModel.DynamicOption)
}
...
extension RMSearchView: RMSearchInputViewDelegate {
    func rmSearchInputView(_ inputView: RMSearchInputView,
        ...
        delegate?.rmSearchView(self, didSelectionOption: option)
